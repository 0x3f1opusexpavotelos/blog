...
## The ecosystem and specturm
You can use  Auth as a standalone product,
but it's also built to integrate with the  ecosystem.

using db under htehood
data and Auth info store shcema
The Auth Token scopes database access on a row-by-row level with RLS policies.


## Providers


Social and Phone Auth using third-party providers.
